...
@click.command()
@click.option('--env_name', type=click.Choice(['FetchPickAndPlace-v1', 'FetchSlide-v1', 'FetchPush-v1', 'HandManipulateBlockFull-v0', \
        'HandManipulateEggFull-v0','HandManipulatePenRotate-v0']), default='FetchPickAndPlace-v1', help='the name of the OpenAI\
